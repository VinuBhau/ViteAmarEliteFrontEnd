  ...
  return (
    ...
    <div className="space-y-5 ">
      ...
      <div className="relative">
        <input
          type="text"
          className="w-full px-4 py-3 bg-white text-gray-700 rounded-lg border border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-300 shadow-md"
      ...
      <div className="text-center">
        <button
          className="w-full px-4 py-3 bg-white font-medium text-white bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-900 focus:outline-none focus:ring-4 focus:ring-blue-500"
